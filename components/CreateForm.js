...
export default function CreateForm(){
  ...
  return(
    <>
    <form onSubmit={formSubmitHandler} className='w-3/4 p-4 mx-auto my-auto rounded-md border border-green-600 bg-green-300 mt-8' >
    <div className="flex justify-evenly items-end my-1  pt-2 pb-4 font-semibold">
      ...
      <button className='block w-1/2 rounded-md mx-4 p-2 font-bold bg-green-500'>CREATE STAND </button>
      </div>
    <div className='flex items-stretch justify-evenly'>
      ...
      <div className='p-1 rounded-md'>
        ...
        <input name="average_cookie_per_sale" className='block w-full m-1 pl-1 ' id='average_cookie_per_sale' defaultValue = '0'/>
